...
$config['theme'] = 'cats';  	// название папки содержащая аватарки
								/*
								 *  1. Папки аватарок в папке /imgs
								 * 
								 *  2. Примеры гендерных тем: 
								 * 		2.1 advtime  - 10 мужчин и 10 женщин формат .png 
								 * 		2.2 monoface - 10 мужчин и 10 женщин формат .png
								 * 
...
$config['extension'] = 'gif';  	// расширение файла
								/*
...
$config['gender'] = false; 		// выделять аватарку как мужскую и женскую?
								/*
...
$config['number'] = 30;  		// номер последней аватарки в папке
								/*
